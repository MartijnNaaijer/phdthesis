...
mosaicplot(ebh_lbh, main = '', cex.axis = 1.2, color = c('#E6B0AA', '#5DADE2'), las = 2)

#############################################################################################

# main/subordinate clauses
main_sub <- table(dat.t$main_sub, dat.t$cl_type)
mosaicplot(main_sub, main = '', cex.axis = 1.2, color = c('#E6B0AA', '#5DADE2'), las = 2)

###############################################

# discourse
txt_type <- table(dat.t$txt_type, dat.t$cl_type)
mosaicplot(txt_type, main = '', cex.axis = 1.2, color = c('#E6B0AA', '#5DADE2'), las = 2)
